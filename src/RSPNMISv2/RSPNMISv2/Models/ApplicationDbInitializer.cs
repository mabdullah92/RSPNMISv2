...
namespace RSPNMISv2.Models
{
    public class ApplicationDbInitializer : CreateDatabaseIfNotExists<ApplicationDbContext>
    {
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            defaultPartnerOrganizations.Add(new PartnerOrganization() { Abbr = "AJKRSP", ColorCode = "#000990", Description = "Azad Jammu Kashmir Rural Support Programme", IsActive = true, OrderIndex = 1000, Title = "Azad Jammu Kashmir Rural Support Programme", YearFounded = 2000 });
            ...
            defaultPartnerOrganizations.Add(new PartnerOrganization() { Abbr = "BRSP", ColorCode = "#000990", Description = "Balochistan Rural Support Programme", IsActive = true, OrderIndex = 1000, Title = "Balochistan Rural Support Programme", YearFounded = 2001 });
            ...
            defaultPartnerOrganizations.Add(new PartnerOrganization() { Abbr = "NRSP", ColorCode = "#000990", Description = "National Rural Support Organization", IsActive = true, OrderIndex = 1000, Title = "National Rural Support Organization", YearFounded = 1992 });
            ...
            defaultPartnerOrganizations.Add(new PartnerOrganization() { Abbr = "SRSO", ColorCode = "#110990", Description = "Sindh Rural Support Organization", IsActive = true, OrderIndex = 1000, Title = "Sindh Rural Support Organization", YearFounded = 2003 });
